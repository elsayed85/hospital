          ...
          <div class="bs-stepper-content p-1">
            <form onSubmit="return false">
              ...
              <div id="submit" class="content text-center pt-3 pt-lg-0">
                ...
                <!-- image -->
                <img src="{{asset('/img/illustrations/girl-doing-yoga-'.$configData['style'].'.png')}}" alt="Create App img" width="300" class="img-fluid" data-app-light-img="illustrations/girl-doing-yoga-light.png" data-app-dark-img="illustrations/girl-doing-yoga-dark.png">
